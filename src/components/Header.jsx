...
const Header = () => {
  return (
    ...
    <Navbar />
    <motion.div initial={{opacity:0,y:100}} transition={{duration:1.5}} whileInView={{opacity:1,y:0}} viewport={{once:true}} className='container text-center mx-auto py-4 py-6 md:px-20 lg:px-32 text-white'>
        ...
        <div className='space-x-6 mt-16'>
            ...
            <a href="#Contact" className='bg-gray-500 px-8 py-3 rounded'>Contact Us</a>
        </div>
    </motion.div>
    </div>
  )
